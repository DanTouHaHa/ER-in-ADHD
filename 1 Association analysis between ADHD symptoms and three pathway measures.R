...
ABCD_CBCL_Emotion_Cognition_MOtivation_FL2[87] <- lapply(ABCD_CBCL_Emotion_Cognition_MOtivation_FL2[87], as.numeric)
...
ABCD_CBCL_Emotion_Cognition_MOtivation_FL2[88:90] <- lapply(ABCD_CBCL_Emotion_Cognition_MOtivation_FL2[88:90], as.numeric)
